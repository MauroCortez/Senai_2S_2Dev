...
namespace senai_filmes_webApi.Interfaces
{
    public interface IGeneroRepository
    {
        ...
        /// </summary>
        /// <param nome="novoGenero">Objeto novoGenero com as informações que serão cadastradas</param>
        void Cadastrar(GeneroDomain novoGenero);

        /// <summary>
        /// Atualiza um gênero existente passando o id pelo corpo da requisição
        /// </summary>
        /// <param name="genero">Objeto gênero com as nosvas informações</param>
        ...
        /// <param name="genero">Objeto genero com as novas informções</param>
